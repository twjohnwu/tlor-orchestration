...
| Coverage comparison | S-29 | `spec.md` AND `tasks.md` exist | either the manual or automatable track is below 100% coverage against `tasks.md` (`[INFRA]` tasks / content under the `prototype` directory excluded from the denominator) |
